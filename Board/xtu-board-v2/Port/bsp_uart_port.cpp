...
static BspUartOpaque s_uart2 {&huart2,  nullptr, s_uart2_rx,  0, {}};
...
static inline BspUartOpaque* from_hal(UART_HandleTypeDef* huart)
{
    ...
    if (huart == &huart2)  return &s_uart2;
...
BspUartHandle bsp_uart_get(BspUartId id)
{
    switch (id)
    {
        ...
        case BSP_UART2:   return reinterpret_cast<BspUartHandle>(&s_uart2);
